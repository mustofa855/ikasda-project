    ...
    <div class="container mx-auto p-6">
      ...
      <nav class="mb-6 text-sm">
        <ol class="list-reset flex text-gray-600">
          <li>
            <router-link to="/alumni" class="text-blue-600 hover:underline">Ikasda</router-link>
          </li>
          <li><span class="mx-2">></span></li>
          <li>
            <router-link to="/alumni/news" class="text-blue-600 hover:underline">News</router-link>
          </li>
          <li><span class="mx-2">></span></li>
