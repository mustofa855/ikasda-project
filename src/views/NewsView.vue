  ...
  <div class="bg-gray-100 min-h-screen">
    ...
    <section class="py-16 px-4 bg-white">
      <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        <!-- Featured News: mengambil berita pertama -->
        <div class="lg:col-span-2 relative" v-if="featuredNews">
          <img
          ...
          <div class="absolute inset-0 bg-black bg-opacity-50 rounded-lg flex flex-col justify-end p-6">
            ...
            <router-link
              ...
              class="inline-block bg-ikasda-primary text-white px-4 py-2 rounded hover:bg-blue-700"
            >
              Baca Selengkapnya
            </router-link>
    ...
    <section class="py-16 px-4 bg-gray-50">
      <div class="max-w-7xl mx-auto">
        <div v-for="(posts, category) in groupedNews" :key="category" class="mb-10">
          <!-- Judul kategori dengan garis warna di samping -->
