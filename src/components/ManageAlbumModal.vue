          ...
          <div class="flex justify-end">
            <button
              ...
              :class="[
                ...
                !newCoverFile ? 'bg-blue-600 opacity-50 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 text-white'
              ]"
            >
              Simpan Perubahan
            </button>
        ...
        <div class="flex justify-end">
          <button
            ...
            :class="[
              ...
              !selectedFiles.length ? 'bg-green-600 opacity-50 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700 text-white'
            ]"
          >
            Unggah Foto
          </button>
  ...
  export default {
      ...
      album: {
        ...
        handler(newVal) {
          if (newVal) {
            ...
            this.fetchImages(newVal.id); // Ambil foto dari album melalui endpoint detail
          }
        }
      }
    },
    methods: {
      ...
      fetchImages(albumId) {
        ...
        axios
          .get(`http://127.0.0.1:8000/api/galleryalbums/${albumId}/`, {
            headers: { Authorization: `Bearer ${token}` }
          })
          .then(response => {
            // Ambil foto dari properti 'images' yang sudah di-nested oleh serializer
      ...
      uploadImages() {
        ...
        axios
          ...
          .then(() => {
            ...
            this.selectedFiles = [];
            // Ambil ulang foto untuk album yang sedang dikelola
            this.fetchImages(this.album.id);
          })
          .catch(error => {
          ...
          if (result.isConfirmed) {
            ...
            axios
              ...
              .then(() => {
                ...
                // Ambil ulang foto setelah penghapusan
                this.fetchImages(this.album.id);
              })
              .catch(error => {
